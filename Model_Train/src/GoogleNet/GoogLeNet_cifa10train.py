...
def main():
    ...
    data_transform = {
        "train": transforms.Compose([transforms.Resize(227),
    ...
    train_dataset = datasets.CIFAR10(
        ...
        transform=data_transform["train"]  # 数据集转换参数
    )
    ...
    validate_dataset = datasets.CIFAR10(
        root='../../data',  # 下载路径
        train=False,  # 是 train 集
        download=True,  # 如果该路径没有该数据集，就下载
        transform=data_transform["val"]  # 数据集转换参数
    )
    ...
    epochs = 20
    save_path = '../../pth_save/GoogLeNet_cifa1.pth'
    model_name = "GoogLeNet_cifa1"
    best_acc = 0.0
